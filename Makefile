...
PLACES=BC:data/extract/north-america/ca/british-columbia-latest.osm.pbf \
	   ...
	   toronto:data/metro/toronto_canada.osm.pbf \
           ontario:data/extract/north-america/canada/ontario-latest.osm.pbf \
           italy:data/extract/europe/italy-latest.osm.pbf \
